...
- (void)payWithPaymentInfo:(STPaymentInfo *)paymentInfo
         completionHandler:(STPaymentsCompletionHandler)completionHandler {
    ...
    NSString *mch_create_ip = [STUtil getIPAddress];
    ...
    [[SPHTTPManager sharedInstance] post:@"pay/gateway"
                                 ...
                                 success:^(id operation, id responseObject)
     {
         ...
         //调起SPaySDK支付
         [[SPayClient sharedInstance] pay:[STUtil currentVisibleViewController]
                                   amount:amount
